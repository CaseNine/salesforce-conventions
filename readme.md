...
To stay within Governor Limits, avoid using more SOQL queries and DML statements than absolutely necessary by calling on a repository as little as possible.
